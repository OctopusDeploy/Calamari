...
namespace Calamari.Build
{
    public static class Signing
    {
        ...
        public static void SignAndTimestampBinaries(string outputDirectory,
                                               ...
                                               string displayUrl = "")
        {
            ...
            foreach (var url in TimestampUrls)
            {
                try
                {
                    AzureSignToolTasks.AzureSignTool(_ => _.SetKeyVaultUrl(vaultUrl)
                ...
                catch (Exception ex)
                {
                    ...
                    {
                        Log.Error(ex, "Failed to sign files using timestamp url {Url}. Trying the next timestamp url",
                                  url);
                    }
                    else
                    {
