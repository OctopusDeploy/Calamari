                        ...
                        else
                        {
                                ...
                                && structureWeAreReplacing.Value.startEvent.Path == node.Path)
                            {
                                outputEvents.AddRange(ParseFragment(structureWeAreReplacing.Value.replacementValue,
                                                                    mappingStart.Event.Anchor.IsEmpty ? null : mappingStart.Event.Anchor.Value,
                                                                    mappingStart.Event.Tag.IsEmpty ? null : mappingStart.Event.Tag.Value));
                            ...
                            {
                                outputEvents.AddRange(ParseFragment(structureWeAreReplacing.Value.replacementValue,
                                                                    sequenceStart.Event.Anchor.IsEmpty ? null : sequenceStart.Event.Anchor.Value,
                                                                    sequenceStart.Event.Tag.IsEmpty ? null : sequenceStart.Event.Tag.Value));
                                structureWeAreReplacing = null;
                            }
