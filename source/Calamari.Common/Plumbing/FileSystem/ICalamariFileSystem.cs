...
namespace Calamari.Common.Plumbing.FileSystem
{
    public interface ICalamariFileSystem
    {
        ...
        IEnumerable<string> EnumerateFilesWithGlob(string parentDirectoryPath, bool enableGroupSupport, params string[] globPatterns);
        ...
        void PurgeDirectory(string targetDirectory, FailureOptions options, bool enableGlobGroupSupport, params string[] globs);
