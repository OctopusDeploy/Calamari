...
namespace Calamari.Common.FeatureToggles
{
    public static class OctopusFeatureToggles
    {
        public static class KnownSlugs
        {
            ...
            public const string ConfigurablePackageCacheRetention = "configurable-package-cache-retention";
        };
        ...
        public static readonly OctopusFeatureToggle ConfigurablePackageCacheRetentionFeatureToggle = new OctopusFeatureToggle(KnownSlugs.ConfigurablePackageCacheRetention);
