...
namespace Calamari.Integration.Packages.Metadata
{
    ...
    {
        public PhysicalPackageMetadata ParseMetadata(string packageId, string version, long size, string hash)
        {
            try
            {
                /*
                 ...
                 */
                return new MavenPackageIDParser().GetMetadataFromPackageID(packageId, version, null, size, hash);
            }
            catch
            {
                /*
                 ...
                 */
                return new NuGetPackageIDParser().GetMetadataFromPackageID(packageId, version, null, size, hash);    
            }            
        }
