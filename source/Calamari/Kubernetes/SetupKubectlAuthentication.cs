    ...
    public class SetupKubectlAuthentication
    {
        ...
        bool TrySetupContext(string kubeConfig, string @namespace, string accountType)
        {
            ...
            else
            {
                ...
                else if (accountType == AccountTypes.AmazonWebServicesAccount || variables.GetFlag("Octopus.Action.AwsAccount.UseInstanceRole") || AccountTypes.AmazonWebServicesOidcAccount)
                {
