...
if ($psVersion.Major -ge 7 -and $psVersion.Minor -ge 3) {
	...
	Invoke-Command -Session $compatSession -ScriptBlock $DeployIISScriptBlock -ArgumentList $OctopusParameters
}
else {
	&$DeployIISScriptBlock -OctopusParameters $OctopusParameters
}
