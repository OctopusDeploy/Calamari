...
{
    public class ImportCertificateCommand2 : Calamari.Shared.Commands.ICustomCommand
    {
        ...
        {
            return commandBuilder.AddConvention(ImportCertificate);
        }
        ...
        static ICollection<PrivateKeyAccessRule> GetPrivateKeyAccessRules(VariableDictionary variables)
        {
