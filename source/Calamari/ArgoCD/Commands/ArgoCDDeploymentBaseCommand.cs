...
{
    public abstract class ArgoCDDeploymentBaseCommand : Command
    {
        public const string PackageDirectoryName = "package";
         const string InlineYamlFileName = "customresource.yml";
         ...
         protected ArgoCDDeploymentBaseCommand(ILog log, IDeploymentJournalWriter deploymentJournalWriter, IVariables variables, ICalamariFileSystem fileSystem,
