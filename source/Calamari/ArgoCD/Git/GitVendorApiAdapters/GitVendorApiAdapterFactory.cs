...
namespace Calamari.ArgoCD.Git.GitVendorApiAdapters
{
    ...
    {
        IGitVendorApiAdapter Create(IRepositoryConnection repositoryConnection);
    }
    ...
    /// </summary>
    public interface IResolvingGitVendorApiAdapterFactory : IGitVendorApiResolver, IGitVendorApiAdapterFactory;
}