     ...
     public ProcessApplicationResult ProcessApplication(
            ...
            ArgoCDGatewayDto gateway)
        {
            ...
            return new ProcessApplicationResult(
                                                ...
                                                appliedSourcesResults.Select(r => new TrackedSourceDetail(r.applicationSource.Source.OriginalRepoUrl, r.UpdateResult.PushResult?.CommitSha, r.UpdateResult.PushResult?.CommitTimestamp, r.applicationSource.Index, [], r.UpdateResult.PatchedFiles)).ToList(),
