...
namespace Calamari.ArgoCD.Conventions
{
    public class UpdateArgoCDAppImagesInstallConvention : IInstallConvention
    {
        ...
        public void Install(RunningDeployment deployment)
        {
            ...
            var sshGitCredentials = (argoProperties.SshCredentials ?? []).ToDictionary(c => c.Url);
            var authenticatingRepositoryFactory = new AuthenticatingRepositoryFactory(gitCredentials, sshGitCredentials, repositoryFactory, log);
