...
namespace Calamari.Deployment.Conventions
{
    ...
    {
        public RollbackScriptConvention(string scriptFilePrefix, ICalamariFileSystem fileSystem, ICombinedScriptEngine scriptEngine, ICommandLineRunner commandLineRunner) :
