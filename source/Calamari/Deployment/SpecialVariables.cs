namespace Calamari.Deployment
{
    public static class SpecialVariables
    {
        ...
        public static class Package
        {
            ...
            public static readonly string SubstituteInJsonFilesEnabled = "Octopus.Action.Package.GenerateAppSettingsJson";
            public static readonly string SubstituteInJsonFilesTargets = "Octopus.Action.Package.AppSettingsJsonPath";
