...
namespace Octopus.Calamari.ConsolidatedPackage
{
    public class MigratedCalamariFlavours
    {
        ...
        public static List<string> TestFlavours => FullFrameworkOnlyFlavours.Concat(CrossPlatformTestFlavours).ToList();
        ...
        public static List<string> CrossPlatformTestFlavours = new()
        {
