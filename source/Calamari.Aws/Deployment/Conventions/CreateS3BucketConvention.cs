...
public class CreateS3BucketConvention(AwsEnvironmentGeneration awsEnvironmentGeneration, Func<RunningDeployment, string> bucketFactory, ILog log) : IInstallConvention
{
    ...
    async Task EnsureBucketExists(Func<AmazonS3Client> clientFactory, string bucketName)
    {
