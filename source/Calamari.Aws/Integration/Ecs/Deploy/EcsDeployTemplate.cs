...
sealed class EcsDeployTemplate
{
        ...
        Cfn.Value<string> awsRegionRef) => new()
    {
        ...
        StartTimeout = c.StartTimeout.ConvertedOrDefault<int?>(s => int.Parse(s, CultureInfo.InvariantCulture)),
        StopTimeout = c.StopTimeout.ConvertedOrDefault<int?>(s => int.Parse(s, CultureInfo.InvariantCulture)),
