...
public static class EcsTemplateParameterNames
{
    ...
    public const string DesiredCount = "DesiredCount";
    public const string MinimumHealthPercent = "MinimumHealthPercent";
    public const string MaximumHealthPercent = "MaximumHealthPercent";
}