...
public class AwsWorkerAuthenticationDetails : AwsAuthenticationDetails<AwsWorkerCredentials>, IAwsAuthenticationDetails
{
    ...
    static bool TryGetEnvironmentVariablesAwsCredentials(ILog log, out AWSCredentials credentials)
    {
        try
        {
    ...
    static bool TryGetInstanceProfileAwsCredentials(ILog log, out AWSCredentials credentials)
    {
        try
        {
