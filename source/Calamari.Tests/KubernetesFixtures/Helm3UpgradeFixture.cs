    ...
    public class Helm3UpgradeFixture : CalamariFixture
    {
        ...
        {   
            ...
            using (new TemporaryFile(fileName))
            {
                ...
                AddPostDeployMessageCheckAndCleanup(null, false, $"C:/Users/silco/AppData/Local/Temp/helm-v{version}-{platformFile}");
        ...
        void AddPostDeployMessageCheckAndCleanup(string explicitNamespace = null, bool dryRun = false, string workingDirectoryForHelm = null, bool isUsingCustomPackage = false)
        {
            if (dryRun)
            {
            ...
            var helmDeleteCommand = isUsingCustomPackage ? new Helm3CommandBuilder() : HelmBuilder.GetHelmCommandBuilderForInstalledHelmVersion(FileSystem, Variables);
            helmDeleteCommand
