...
//        {
//            var wrapper = new KubernetesContextScriptWrapper(CalamariPhysicalFileSystem.GetPhysicalFileSystem(), new AssemblyEmbeddedResources());
...
//        }
//
//        private void TestScript(IScriptEngine wrapper, string scriptName)
//        {
...
//                deploymentVariables.Set(Shared.SpecialVariables.Account.AccountType, "Token");
//                deploymentVariables.Set(Shared.SpecialVariables.Account.Token, ClusterToken);
//                
...
//        }
//
//        private CalamariResult ExecuteScript(KubernetesContextScriptWrapper wrapper, string scriptName, CalamariVariableDictionary variables)
//        {
