...
{
    public class NamespacedApiResourcesDictBuilder
    {
        readonly IApiResourceScopeLookup apiResourceScopeLookup = Substitute.For<IApiResourceScopeLookup>();

        public NamespacedApiResourcesDictBuilder WithNonNamespacedApiResource(ApiResourceIdentifier apiResourceIdentifier)
        {
            apiResourceScopeLookup
                .TryGetIsClusterScoped(apiResourceIdentifier, out _)
                .Returns(x =>
                         {
                             x[1] = false;
                             return true;
        ...
        public NamespacedApiResourcesDictBuilder WithNamespacedApiResource(ApiResourceIdentifier apiResourceIdentifier)
        {
            apiResourceScopeLookup
                .TryGetIsClusterScoped(apiResourceIdentifier, out _)
                .Returns(x =>
        ...
        public NamespacedApiResourcesDictBuilder WithoutApiResource(ApiResourceIdentifier apiResourceIdentifier)
        {
            apiResourceScopeLookup
                .TryGetIsClusterScoped(apiResourceIdentifier, out _)
                .Returns(false);
        ...
        public NamespacedApiResourcesDictBuilder WithDefaults()
        {
            ...
            var defaultResources = new Dictionary<ApiResourceIdentifier, bool>
            {
            ...
            apiResourceScopeLookup
                .TryGetIsClusterScoped(Arg.Any<ApiResourceIdentifier>(), out _)
                .Returns(x =>
                         {
                            var wasFound = defaultResources.TryGetValue(x.Arg<ApiResourceIdentifier>(), out var isClusterScoped);
                            x[1] = isClusterScoped;
                            return wasFound;
                         });
            return this;
