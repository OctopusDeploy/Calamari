...
namespace Calamari.Tests.Fixtures.Integration.Packages
{
    ...
    public class DockerImagePackageDownloaderFixture
    {
        ...
        static DockerImagePackageDownloader GetDownloader(ILog log)
        {
            ...
            return new DockerImagePackageDownloader(new ScriptEngine(Enumerable.Empty<IScriptWrapper>(), log), CalamariPhysicalFileSystem.GetPhysicalFileSystem(), runner, new CalamariVariables(), log, new EcrFeedLoginDetailsProvider());
        }
    }
}