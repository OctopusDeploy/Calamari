    ...
    public class VariableFactoryFixture
    {
        ...
        public void VariablesInAdditionalVariablesPathAreContributed()
        {
            try
            {
                using (var varFile = new TemporaryFile(Path.GetTempFileName()))
                {
                    ...
                    Environment.SetEnvironmentVariable(Common.Variables.SpecialVariables.AdditionalVariablesPath, varFile.FilePath);
            ...
            {
                Environment.SetEnvironmentVariable(Common.Variables.SpecialVariables.AdditionalVariablesPath, null);
            }
        }
        ...
        public void IfAdditionalVariablesPathDoesNotExistAnExceptionIsThrown()
        {
            try
            {
                ...
                Environment.SetEnvironmentVariable(Common.Variables.SpecialVariables.AdditionalVariablesPath, filePath);
                ...
                new VariablesFactory(CalamariPhysicalFileSystem.GetPhysicalFileSystem())
                    ...
                    .Where(e => e.Message.Contains(Common.Variables.SpecialVariables.AdditionalVariablesPath))
