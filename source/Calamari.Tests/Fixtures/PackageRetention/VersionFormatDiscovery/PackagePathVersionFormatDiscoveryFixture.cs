...
namespace Calamari.Tests.Fixtures.PackageRetention
{
    ...
    public class PackagePathVersionFormatDiscoveryFixture
    {
        ...
        public void TestArgumentsAndResults(string path, VersionFormat defaultFormat, bool expectedResult, VersionFormat expectedFormat)
        {
            ...
            var journal = new Journal(new InMemoryJournalRepositoryFactory(), Substitute.For<ILog>(), Substitute.For<ICalamariFileSystem>(), Substitute.For<IRetentionAlgorithm>(), new CalamariVariables(), Substitute.For<IFreeSpaceChecker>());
