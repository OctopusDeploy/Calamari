...
{
    // Smoke test: a container deploy round-trips against a real Linux app service (web app + slot).
    // The OS branch and targeting logic are unit-tested in AzureAppServiceContainerDeployBehaviourUnitTestFixture.
    public class AzureAppServiceDeployContainerBehaviourFixture
    {
        ...
        public class WhenUsingALinuxAzureAppService : AzureAppServiceWithProvisionedResourcesTestBase
        {
            ...
            protected override string[] ExcludedRegions => new[] { "eastus" };
