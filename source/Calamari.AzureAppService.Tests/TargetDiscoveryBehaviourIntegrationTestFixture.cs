...
{
    readonly string appName = Guid.NewGuid().ToString();
    readonly List<string> slotNames = new List<string> { "blue", "green" };
    static readonly string Type = "Azure";
    static readonly string AuthenticationMethod = "ServicePrincipal";
    static readonly string AccountId = "Accounts-1";
    ...
    async Task<WebSiteResource> CreateOrUpdateTestWebApp(IDictionary<string, string> tags = null)
    {
