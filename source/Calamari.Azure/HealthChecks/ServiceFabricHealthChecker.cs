...
using Calamari.Shared.HealthChecks;
using Calamari.Util;
...
namespace Calamari.Azure.HealthChecks
{
    public class ServiceFabricHealthChecker : IDoesDeploymentTargetTypeHealthChecks
    {
        ...
        public ServiceFabricHealthChecker(ICertificateStore certificateStore)
        {
        ...
        public int ExecuteHealthCheck(VariableDictionary variables)
        {
