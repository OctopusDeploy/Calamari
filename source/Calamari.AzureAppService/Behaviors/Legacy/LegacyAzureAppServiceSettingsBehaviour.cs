...
namespace Calamari.AzureAppService.Behaviors
{
    class LegacyAzureAppServiceSettingsBehaviour : IDeployBehaviour
    {
        ...
        /// <returns></returns>
        private async Task PublishAppSettings(WebSiteManagementClient webAppClient,
                                              ...
                                              string authToken)
        {
            ...
            await AppSettingsManagement.PutSlotSettingsListAsync(webAppClient,
                                                                 targetSite,
                                                                 slotSettings.Union(existingSlotSettings),
                                                                 authToken);
        }

        private async Task PublishConnectionStrings(WebSiteManagementClient webAppClient,
                                                    AzureTargetSite targetSite,
