...
namespace Calamari.Azure.CloudServices.Commands
{
    ...
    public class ExtractAzureCloudServicePackageCommand : Command
    {
        ...
        public override int Execute(string[] commandLineArguments)
        {
            ...
            variables.Set(Common.Variables.KnownVariables.OriginalPackageDirectoryPath, !string.IsNullOrWhiteSpace(destinationDirectory) ? destinationDirectory : Path.GetDirectoryName(packageFile));
