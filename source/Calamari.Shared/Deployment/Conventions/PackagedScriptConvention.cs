...
namespace Calamari.Deployment.Conventions
{
    ...
    {
        public PackagedScriptConvention(string scriptFilePrefix, ICalamariFileSystem fileSystem, ICombinedScriptEngine scriptEngine, ICommandLineRunner commandLineRunner) : 
