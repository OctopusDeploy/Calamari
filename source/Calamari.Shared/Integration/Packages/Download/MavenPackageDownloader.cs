...
namespace Calamari.Integration.Packages.Download
{
    ...
    public class MavenPackageDownloader : IPackageDownloader
    {
        ...
        PackagePhysicalFileMetadata SourceFromCache(string packageId, IVersion version, string cacheDirectory)
        {
            ...
            var files = fileSystem.EnumerateFilesRecursively(cacheDirectory, PackageName.ToSearchPatterns(packageId, version, JarExtractor.SupportedExtensions));
            ...
            XmlDocument snapshotMetadata)
        {
            ...
            var fileChecks = JarExtractor.SupportedExtensions
