...
namespace Calamari.AzureResourceGroup.Tests
{
    ...
    public class DeployAzureResourceGroupConventionFixture
    {
        ...
        {
            // Given / When
            var deploymentName = LegacyDeployAzureResourceGroupBehaviour.GenerateDeploymentNameFromStepName("StepA");
        ...
        {
            // Given / When
            var deploymentName = LegacyDeployAzureResourceGroupBehaviour.GenerateDeploymentNameFromStepName("1234567890123456789012345678901"); // 31 chars
        ...
        {
            // Given / When
            var deploymentName = LegacyDeployAzureResourceGroupBehaviour.GenerateDeploymentNameFromStepName("1234567890123456789012345678901234567890"); // 40 chars
