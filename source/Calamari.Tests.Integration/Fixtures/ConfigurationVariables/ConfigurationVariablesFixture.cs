...
using Calamari.Tests.Integration.Fixtures.Util;
using Calamari.Tests.Integration.Helpers;
using NUnit.Framework;
using Octostache;

namespace Calamari.Tests.Integration.Fixtures.ConfigurationVariables
{
    [TestFixture]
    public class ConfigurationVariablesFixture : CalamariFixture
    {
        ...
        string PerformTest(string sampleFile, IVariableDictionary variables)
        {
