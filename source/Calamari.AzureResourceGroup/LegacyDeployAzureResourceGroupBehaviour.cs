...
{
    class LegacyDeployAzureResourceGroupBehaviour : IDeployBehaviour
    {
        readonly TemplateService templateService;
        readonly IResourceGroupTemplateNormalizer parameterNormalizer;
        readonly ILog log;

        public LegacyDeployAzureResourceGroupBehaviour(TemplateService templateService, IResourceGroupTemplateNormalizer parameterNormalizer, ILog log)
        {
